...
def create_gui():
    ...
    base_folder_entry.grid(row=0, column=1, padx=10, pady=5)
    base_folder_entry.insert(0, default_base_folder)
    tk.Button(root, text="浏览", command=lambda: browse_folder(base_folder_entry)).grid(row=0, column=2, padx=5, pady=5)
    tk.Button(root, text="打开", command=lambda: open_folder(default_base_folder)).grid(row=0, column=3, padx=5, pady=5)
    ...
    tk.Button(root, text="浏览", command=lambda: browse_folder(output_folder_entry)).grid(row=1, column=2, padx=5, pady=5)
    tk.Button(root, text="打开", command=lambda: open_folder(default_output_folder)).grid(row=1, column=3, padx=5, pady=5)
    ...
    log_text.grid(row=3, column=0, columnspan=3, padx=10, pady=5, sticky="nsew")
    ...
    auto_scroll_checkbox.grid(row=4, column=0, columnspan=4, pady=5)
